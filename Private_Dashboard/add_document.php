...
<body class="grey lighten-3">
  ...
  <header>
    ...
    <!-- Sidebar -->
    <div class="sidebar-fixed position-fixed w3-dark-grey">
      <a class="logo-wrapper waves-effect">
      
        <img width="100px" height="100px" src="../Private_Dashboard/img/android-chrome-192x192.png" class="img-fluid" alt="">
      </a>
        ...
        <a href="add_document.php" class="list-group-item list-group-item-action waves-effect">
          ...
          <a href="previewPage.php" class="list-group-item list-group-item-action waves-effect">
        <img width="16" height="16" src="https://img.icons8.com/pastel-glyph/64/4D4D4D/create-new--v1.png" alt="create-new--v1"/> Edit Document</a>
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,ACTYPE,ACREGN,DATE,TIMERS,DOWNLOAD FROM upload_files group by NAME DESC") or die (mysqli_error($con));
      ...
      <td width="20%"><?php echo  $name; ?></td>
       ...
       <td><?php echo $acregn; ?></td>
       <td><?php echo $date; ?></td>
      <td><?php echo $time; ?></td>


           <td><a href='downloads.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a>
           <a href='previewPage.php?ID=<?php echo $id; ?>'  class="btn btn-outline-info"><i class="fa fa-file"></i></a>
...
<?php } ?>
    ...
    <div class="container">
        ...
        <div class="form">
            ...
            <div class="input_field">
                ...
                <input type="text" class="input" name="ACTYPE">
            </div>

            <div class="input_field">
                <label>A/C Registration</label>
                <input type="text" class="input" name="ACREGN">
            </div>
            ...
            <div class="input_field">
                <input type="submit" value="Add Document" class="btn" name="add_docs">
            </div>
        </div>
    </form>
    </div>
  ...
  <?php
    if($_POST['add_docs'])
    {
      ...
      $query = "INSERT INTO UPLOAD_FILES (NAME, ACTYPE, ACREGN, DATE) VALUES('$dname','$actype','$acregn','$docdate')";
